    ...
    return (
        <App>
            <div className="flex items-center justify-center w-screen h-screen flex-col">
                <h1 className="font-sans text-3x1 text-sky-500 pb-1"> AluraX </h1>
                ...
                >
                    ...
                    <button className="mt-5 p-2 rounded bg-emerald-500 hover:bg-emerald-600 text-slate-100" type="submit">
